...
def make_mlp_policy(ob_size, num_actions, hidden_sizes, prev=None):
    return MLPPolicy(ob_size, num_actions, hidden_sizes=hidden_sizes, prev=prev)


def make_conv_policy(ob_size, num_actions, hidden_sizes, prev=None):
    return ConvPolicy(ob_size, num_actions, hidden_sizes=hidden_sizes, prev=prev)
